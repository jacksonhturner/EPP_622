...
BBMap says that SmartDeNOvo is more compact but less info and that Flye 

According to BUSCO, the Flye assemby is better because it has more complete BUSCOs and less missing BUSCOs than the SmartDeNovo assembly. However, the Flye assembly has more fragmented and complete/duplicated and fragmented BUSCOs, but this doesn't, in my opinion, make up for the difference in complete and missing BUSCOs.
